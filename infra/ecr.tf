  ...
  assume_role_policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ...
        StringLike = {
          "token.actions.githubusercontent.com:sub" = "repo:OpenTrain-AI/open-label-runtime:ref:refs/heads/develop"
        }
      }
    }]
  })
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = "arn:aws:ecs:${local.region}:${local.account_id}:service/${local.name}/${local.name}"
      },
    ]
  })
}
